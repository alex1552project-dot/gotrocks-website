...
function showCheckoutStep(step) {
    ...
    if (step === 1) {
        ...
        document.getElementById('checkoutModalTitle').innerHTML = '&#128205; Contact Information';
    } else if (step === 2) {
        document.getElementById('checkoutStep2').style.display = 'block';
        document.getElementById('step1indicator').classList.add('completed');
        document.getElementById('step2indicator').classList.add('active');
        document.getElementById('checkoutModalTitle').innerHTML = '&#128197; Select Delivery Date';
    } else if (step === 3) {
        ...
        document.getElementById('checkoutModalTitle').innerHTML = '&#128179; Review & Pay';
    }
}
